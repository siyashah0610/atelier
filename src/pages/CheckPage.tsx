...
interface AnalysisResult {
  ...
  productImageUrl: string | null  // returned by server for URL/barcode inputs
}
...
export default function CheckPage() {
  const { userProfile, boards, createBoard, addToBoard } = useApp()
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-stone-100 shadow-sm p-5 flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-stone-500 mt-1.5 capitalize">{result.productCategory}</p>
